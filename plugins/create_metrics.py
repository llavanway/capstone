...
def create_metrics():
    ...
    # Ranks
    final_data['rank_units_15_24'] = final_data['units_15_24'].rank(method='min')
    final_data['rank_JobAccess'] = final_data['JobAccess'].rank(method='min')
    final_data['rank_SchoolCapacity'] = final_data['SchoolCapacity'].rank(method='min')
